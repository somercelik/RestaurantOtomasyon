 ...
 */
public class adminpencere extends javax.swing.JFrame {

    /**
     * Creates new form adminpencere
     */
    public adminpencere() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Kullanıcı adi:");

        jLabel3.setText("Şifre:");

        jPasswordField1.setEchoChar('\u03a9');
        jPasswordField1.setFocusAccelerator('\u03a9');
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adminpencere().setVisible(true);
            }
        });
    }
